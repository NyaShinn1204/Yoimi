...
var abema_userid = "EX4EKv39PYnRJF"
var d = h["keys"][0]
var w = d["k"]
...
var wordarray_create = Object.create || function() {
    function e() {}
    return function(t) {
        var n;
...
var encryptionObject = {}
  ...
  , Q = encryptionObject.enc = {}
  , S = encryptionObject.mode = {}
  , E = encryptionObject.mode = {}
  , c = s.Base = {
    extend: function(e) {
        var t = wordarray_create(this);
        return e && t.mixIn(e),
...
var l = d["kid"]
var g = p["slice"](0, p["indexOf"]("."))
decrypt_y = (o = encryptionObject, u = Cr(l, abema_userid, g), o["lib"]["WordArray"]["create"](u));
console.log("Y:", decrypt_y)

const CryptoJS = require("crypto-js");
console.log(CryptoJS.enc.Utf8.parse(decrypt_uuid));