...
options.add_argument("--headless")  # ヘッドレスモード（ブラウザを画面に表示しない）
driver = webdriver.Chrome(options=options)

# Fingerprint2ライブラリを手動でJavaScriptコードとして挿入
fingerprint2_js = """
!function(e, t, a) {
    "use strict";
...
# スクリプトを実行して指紋を取得
driver.execute_script(fingerprint2_js)

fingerprint = driver.execute_script(payload_js)
