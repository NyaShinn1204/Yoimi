...
def login(self, email, password):
    ...
    response1 = self.session.get("https://animestore.docomo.ne.jp/animestore/auth", allow_redirects=False)
    
    response2 = self.session.get(response1.headers["Location"], allow_redirects=False)
