        ...
        if status == False:
            ...
            for message in messages:
                ...
                if additional_info[2]:        
                    ...
                    logger.info(f"Getting Niconico Comment", extra={"service_name": __service_name__})
                    ...
                    logger.info(f" + Hit Channel: {', '.join(total_tv)}", extra={"service_name": __service_name__})
                    logger.info(f" + Total Comment: {str(total_comment)}", extra={"service_name": __service_name__})
                    ...
                    logger.info(f" + XML data saved to: {saved_filename}", extra={"service_name": __service_name__})
